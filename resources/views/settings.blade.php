...
<main>
    <div class="side-nav">
        <ul class="list-group list-group-flush"><a class="list-group-item" href="dashboard.html" data-toggle="tooltip" data-placement="bottom" title="Dashboard"><i class="las la-shapes la-lw"></i><span>Басты бет</span></a><a class="list-group-item" href="patients.html" data-toggle="tooltip" data-placement="bottom" title="Санаторийлер"><i class="las la-user-injured la-lw"></i><span>Санаторийлер</span></a><a class="list-group-item" href="specialists.html" data-toggle="tooltip" data-placement="bottom" title="Specialists"><i class="las la-clinic-medical la-lw"></i><span>Дәрігерлер</span></a><a class="list-group-item" href="procurement.html" data-toggle="tooltip" data-placement="bottom" title="Procurement"><i class="las la-shopping-cart la-lw"></i><span>Ем түрлері</span></a><a class="list-group-item" href="notifications.html" data-toggle="tooltip" data-placement="bottom" title="Notifications"><i class="las la-sms la-lw"></i><span>Хабарламалар</span></a><a class="list-group-item" href="settings.html" data-toggle="tooltip" data-placement="bottom" title="Баптаулар"><i class="las la-cogs la-lw"></i><span>Баптаулар</span></a>
            <hr class="divider" />
            <div class="aob-items">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="sub-section col-lg-10 col-md-12">
                            ...
                            <div class="sub-section-body">
                                <div class="row">
                                    <div class="col-lg-2 col-md-4"><img class="rounded-circle" src="../SiteAssets/images/doctor.svg" /></div>
                                    <div class="col-lg-6 col-md-8">
                                        <div class="d-flex mb-2"><button class="btn btn-sm btn-dark-red-f"><i class="las la-upload"></i>upload new photo</button><button class="btn btn-sm btn-darker-grey-o ml-2"><i class="las la-trash"></i>remove</button></div>
                        ...
                        <div class="sub-section col-md-12 col-lg-8">
                            ...
                            <div class="sub-section-body">
                                <div class="user-details-form">
                                    <div class="form-row">
                                        <div class="form-group col-sm-6"><label>first name</label><input class="form-control" value="jane" /></div>
                                        <div class="form-group col-sm-6"><label>last name</label><input class="form-control" value="doe" /></div>
                                        <div class="form-group col-sm-8 col-md-12 col-lg-8"><label>email address</label><input class="form-control" value="abc@def.com" /></div>
                                        <div class="form-group col-sm-8 col-md-12 col-lg-8"><label>telephone number</label><input class="form-control" value="+243989120" type="tel" /></div>
                                    </div><button class="btn btn-dark-red-f-gr mt-4"><i class="las la-save"></i>save changes</button></div>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="sub-section col-sm-8 col-md-12 col-lg-8">
                            <div class="sub-section-body">
                                <div class="user-password-form">
                                    <div class="form-row">
                                        <div class="form-group col-sm-8"><label>current password</label><input class="form-control" value="password" type="password" /></div>
                                        <div class="form-group col-sm-8"><label>new password</label><input class="form-control" value="abc@def.com" type="password" /></div>
                                        <div class="form-group col-sm-8"><label>re-type new password</label><input class="form-control" value="abc@def.com" type="password" /></div>
                                    </div><button class="btn btn-dark-red-f-gr mt-4"><i class="las la-sync"></i>change my password</button></div>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="sub-section col-sm-8 col-md-12 col-lg-6">
                            <div class="sub-section-body">
                                <div class="user-notifications-form">
                                    <div class="custom-control custom-switch"><input class="custom-control-input" id="customSwitch1" type="checkbox" /><label class="custom-control-label" for="customSwitch1">Subscribe to our monthly newsletter</label></div>
                                    <div class="custom-control custom-switch"><input class="custom-control-input" id="customSwitch2" type="checkbox" checked="checked" /><label class="custom-control-label" for="customSwitch2">Enable custom notifications via email</label></div><button class="btn btn-dark-red-f-gr mt-4"><i class="las la-save"></i>save changes</button></div>
                            </div>
                        </div>
                    </div>
                </div>
